<template>
	<view class="qiun-columns">
		<view class="qiun-charts">
			<canvas canvas-id="sevenEle" id="sevenEle" class="charts" :width="cWidth*pixelRatio" :height="cHeight*pixelRatio"
...
<script>
	...
	export default {
		...
		methods: {
			...
			getServerData() {
				...
				uni.request({
					...
					success: function(res) {
						...
						//第二根线为虚线的设置
						_self.showLineA("sevenEle", LineA);
					},
					fail: () => {
			...
			touchLineA(e) {
				sevenEle.scrollStart(e);
			},
			moveLineA(e) {
				sevenEle.scroll(e);
			},
			touchEndLineA(e) {
				sevenEle.scrollEnd(e);
				//下面是toolTip事件，如果滚动后不需要显示，可不填写
				sevenEle.touchLegend(e);
				sevenEle.showToolTip(e, {
